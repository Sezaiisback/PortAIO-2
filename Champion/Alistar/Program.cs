    ...
    internal class Program
    {
        ...
        private static void GenerateMenu()
        {
            try
            {
                ...
                comboMenu.Add("ElAlistar.Combo.RHeal.HP", new Slider("R on Health percentage", 60));
                comboMenu.Add("ElAlistar.Combo.RHeal.Damage", new Slider("R on damage dealt %", 60));
                ...
                healMenu.Add("Heal.HP", new Slider("Health percentage", 80));
                healMenu.Add("Heal.Damage", new Slider("Heal on damage dealt %", 80));
                healMenu.Add("ElAlistar.Heal.Mana", new Slider("Minimum mana", 20));
