...
namespace PortAIO.Champion.Amumu
{
    public class Program
    {
        ...
        public static void OnLoad()
        {
            ...
            Menu = MainMenu.AddMenu("AmumuSharp", "AmumuSharp");

            comboMenu = Menu.AddSubMenu("Combo", "Combo");
            comboMenu.Add("comboQ", new Slider("Use Q (1 : Never | 2 : Always | 3 : If out of range)", 2, 1, 3));
            comboMenu.Add("comboW", new CheckBox("Use W"));
            comboMenu.Add("comboE", new CheckBox("Use E"));
            comboMenu.Add("comboR", new Slider("Auto Use R", 3, 0, 5));
            comboMenu.Add("comboWPercent", new Slider("Use W until Mana %", 10));

            farmMenu = Menu.AddSubMenu("Farming", "Farming");
            farmMenu.Add("farmQ", new Slider("Use Q (1 : Never | 2 : Always | 3 : If out of range)", 2, 1, 3));
            farmMenu.Add("farmW", new CheckBox("Use W"));
            farmMenu.Add("farmE", new CheckBox("Use E"));
            farmMenu.Add("farmWPercent", new Slider("Use W until Mana %", 20));
            ...
            miscMenu.Add("aimQ", new KeyBind("Q near mouse", false, KeyBind.BindTypes.HoldActive, 'T'));
