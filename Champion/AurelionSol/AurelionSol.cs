    ...
    internal class AurelionSol
    {
        ...
        private static void GenerateMenu()
        {
            try
            {
                ...
                laneClearMenu.Add("laneclear.Mana", new Slider("Minimum mana", 20));

                jungleClearMenu = menu.AddSubMenu("Jungleclear", "Jungleclear");
                jungleClearMenu.Add("jungleclear.Q", new CheckBox("Use Q"));
                jungleClearMenu.Add("aneclear.minionshit", new Slider("Minimum minions killable (Q)", 1, 1, 5));
                jungleClearMenu.Add("jungleclear.Mana", new Slider("Minimum mana", 20));

                ksMenu = menu.AddSubMenu("Killsteal", "Killsteal");
                ksMenu.Add("Killsteal.Active", new CheckBox("Activate killsteal"));
                ksMenu.Add("Killsteal.R", new CheckBox("Use R"));
                ...
                drawMenu.Add("Draw.Off", new CheckBox("Disable drawings", false));
