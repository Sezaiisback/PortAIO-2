...
namespace e.Motion_Katarina
{
    class Program
    {
        ...
        public static void Game_OnGameLoad()
        {
            ...
            #region Menu
            _menu = MainMenu.AddMenu("e.Motion Katarina", "motion.katarina");

            //Combo-Menü
            comboMenu = _menu.AddSubMenu("Combo", "motion.katarina.combo");
            comboMenu.Add("motion.katarina.combo.useq", new CheckBox("Use Q"));
            ...
            //Harrass-Menü
            harassMenu = _menu.AddSubMenu("Harass", "motion.katarina.harrass");
            harassMenu.Add("motion.katarina.harass.useq", new CheckBox("Use Q"));
            harassMenu.Add("motion.katarina.harass.usew", new CheckBox("Use W"));
            harassMenu.AddGroupLabel("Auto-Harass");
            harassMenu.Add("motion.katarina.harass.autoharass.toggle", new CheckBox("Automatic Harrass"));
            harassMenu.Add("motion.katarina.harass.autoharass.key", new KeyBind("Toogle Harrass", false, KeyBind.BindTypes.PressToggle, 'N'));
            harassMenu.Add("motion.katarina.harass.autoharass.useq", new CheckBox("Use Q", false));
            harassMenu.Add("motion.katarina.harass.autoharass.usew", new CheckBox("Use W"));

            //Laneclear-Menü
            laneclear = _menu.AddSubMenu("Laneclear", "motion.katarina.laneclear");
            laneclear.Add("motion.katarina.laneclear.useq", new CheckBox("Use Q"));
            laneclear.Add("motion.katarina.laneclear.usew", new CheckBox("Use W"));
            laneclear.Add("motion.katarina.laneclear.minw", new Slider("Minimum Minions to use W", 3, 1, 6));
            laneclear.Add("motion.katarina.laneclear.minwlasthit", new Slider("Minimum Minions to Lasthit with W", 2, 0, 6));

            //Jungleclear-Menü
            jungleclear = _menu.AddSubMenu("Jungleclear", "motion.katarina.jungleclear");
            jungleclear.Add("motion.katarina.jungleclear.useq", new CheckBox("Use Q"));
            jungleclear.Add("motion.katarina.jungleclear.usew", new CheckBox("Use W"));
            jungleclear.Add("motion.katarina.jungleclear.usee", new CheckBox("Use E"));

            //Lasthit-Menü
            lasthit = _menu.AddSubMenu("Lasthit", "motion.katarina.lasthit");
            lasthit.Add("motion.katarina.lasthit.useq", new CheckBox("Use Q"));
            lasthit.Add("motion.katarina.lasthit.usew", new CheckBox("Use W"));
            lasthit.Add("motion.katarina.lasthit.usee", new CheckBox("Use E", false));
            lasthit.Add("motion.katarina.lasthit.noenemiese", new CheckBox("Only use E when no Enemies are around"));

            //KS-Menü
            ksMenu = _menu.AddSubMenu("Killsteal", "motion.katarina.killsteal");
            ksMenu.Add("motion.katarina.killsteal.useq", new CheckBox("Use Q"));
            ksMenu.Add("motion.katarina.killsteal.usew", new CheckBox("Use W"));
            ksMenu.Add("motion.katarina.killsteal.usee", new CheckBox("Use E"));
            ksMenu.Add("motion.katarina.killsteal.usef", new CheckBox("Use Ignite"));
            ksMenu.Add("motion.katarina.killsteal.wardjump", new CheckBox("KS with Wardjump"));

            //Drawings-Menü
            drawingsMenu = _menu.AddSubMenu("Drawings", "motion.katarina.drawings");
            drawingsMenu.Add("motion.katarina.drawings.drawq", new CheckBox("Draw Q", false));
            drawingsMenu.Add("motion.katarina.drawings.draww", new CheckBox("Draw W", false));
            drawingsMenu.Add("motion.katarina.drawings.drawe", new CheckBox("Draw E", false));
            drawingsMenu.Add("motion.katarina.drawings.drawr", new CheckBox("Draw R", false));
            drawingsMenu.Add("motion.katarina.drawings.dmg", new CheckBox("Draw Damage to target"));
            drawingsMenu.Add("motion.katarina.drawings.drawalways", new CheckBox("Draw Always", false));

            //Misc-Menü
            miscMenu = _menu.AddSubMenu("Miscellanious", "motion.katarina.misc");
            miscMenu.Add("motion.katarina.misc.wardjump", new CheckBox("Use Wardjump"));
            ...
            performanceMenu = _menu.AddSubMenu("Performance", "motion.katarina.performance");
            performanceMenu.Add("motion.katarina.performance.track", new Slider("Tracked minions for Lasthitting", 3, 1, 10));
